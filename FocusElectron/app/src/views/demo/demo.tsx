...
export default class Demo extends React.Component<DemoProps, DemoState> {
            ...
            <div className="layout-padding">
                <Card title="Redux Test" className="mb-16">
                    ...
                    <p className="text-gray mt-16 mb-16">
                        Redux runs in the main process, which means it can be shared across all
                        renderer processes.
                    </p>
                    ...
                    <Spin spinning={loading}>
                        <div className="mb-16">
                            ...
                            <Button
                                className="ml-16"
                                type="primary"
                                onClick={this.requestTestError.bind(this)}
                            >
                            ...
                            <Button
                                className="ml-16"
                                type="primary"
                                onClick={this.requestTestErrorModal.bind(this)}
                            >
                                Request Error (modal)
                            </Button>
                        </div>
    ...
    requestTestErrorModal(): void {
        this.setState({ loading: true })
        $api.queryTestInfoError({}, { errorType: 'modal' })
            .catch((resData) => {
                this.setState({ resData })
            })
            .finally(() => this.setState({ loading: false }))
